...
left_camera_matrix = np.array([[824.93564, 0., 251.64723],
                               ...
                               [0., 0., 1.]])
left_distortion = np.array([[0.23233, -0.98375, 0.00160, 0.00155, 0.00000]])
...
right_camera_matrix = np.array([[853.66485, 0., 217.00856],
                                ...
                                [0., 0., 1.]])
right_distortion = np.array([[0.30729, -1.61541, 0.01395, -0.00768, 0.00000]])

om = np.array([0.01901, 0.0315, -0.00950]) # 旋转关系向量
